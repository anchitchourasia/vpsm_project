...
export const API_CONFIG = {
  ...
  // ── AUTH ENDPOINTS (NEW — required by auth.service.ts) ──
  AUTHORITY_LOGIN  : `${environment.apiBaseUrl}/api/authority/login`,
  EMPLOYEE_REPORT  : `${environment.apiBaseUrl}/api/employees/list`,
